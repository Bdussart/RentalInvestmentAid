    ...
    public class GeminiTreatment : MustInitializeCache
    {
        ...
        public async Task<string> GetPromptInformation(AnnouncementInformation announcement)
        {
            ...
            GeminiPromptData promptData = new GeminiPromptData
            {
                ...
                Informations = $"La ville : {announcement.CityInformations.CityName} code postal  : {announcement.CityInformations.ZipCode} prix : {announcement.Price} metrage : {announcement.Metrage} type : {announcement.RentalType} descrption {announcement.Description}"
            };
